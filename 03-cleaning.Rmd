...
```
Hence, the resulting variables in the dataset are: 'location', 'time', 'smoothed estimated percentage of COVID-related doctor's vistis'. There are 3303 samples in total, corresponding to different time and locations.
...
The resulting variables are: 'location', 'time', 'smoothed estimated percentage of new hospital admissions related to COVID'. There are 2952 sample in total, corresponding to different time and locations.
